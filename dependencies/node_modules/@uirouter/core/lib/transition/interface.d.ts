...
export interface IHookRegistry {
     ...
     * #### Default Substate
     *
     * This example redirects any transition from 'hostPage' to 'hostPage.dashboard'.  This is commonly referred to as a
     * "default substate".
     *
     * @example
     * ```js
     * // ng2
     * transitionService.onBefore({ to: 'hostPage' }, (trans: Transition) =>
     *     trans.router.stateService.target("hostPage.dashboard"));
     * ```
     *
     ...
     *   defaultSubstate: 'hostPage.dashboard'
     * }
     *
     * var criteria = {
     *   to: function(state) {
