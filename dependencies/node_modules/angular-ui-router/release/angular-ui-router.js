...
var UrlRuleFactory = (function () {
     ...
     * var rule = factory.fromUrlMatcher(urlMatcher, match => "/hostPage/" + match.fooId + "/" + match.barId);
     * var match = rule.match('/foo/123/456'); // results in { fooId: '123', barId: '456' }
     * var result = rule.handler(match); // '/hostPage/123/456'
     * ```
     *
     ...
     * ```js
     * var urlMatcher = $umf.compile("/foo/:fooId/:barId");
     * var handler = $umf.compile("/hostPage/:fooId/:barId");
     ...
     * #### Example:
     * ```js
     * var rule = factory.fromRegExp(/^\/foo\/(bar|baz)$/, match => "/hostPage/" + match[1])
     * var match = rule.match('/foo/bar'); // results in [ '/foo/bar', 'bar' ]
     * var result = rule.handler(match); // '/hostPage/bar'
     * ```
     *
     * ## Handler as string
     *
     ...
     * #### Example:
     * ```js
     * var rule = factory.fromRegExp(/^\/foo\/(bar|baz)$/, "/hostPage/$1")
     * var match = rule.match('/foo/bar'); // results in [ '/foo/bar', 'bar' ]
     * var result = rule.handler(match); // '/hostPage/bar'
     * ```
     */
...
var StateService = (function () {
     ...
     * - `$state.go('^.sibling')` - if current state is `hostPage.child`, will go to the `hostPage.sibling` state
     * - `$state.go('.child.grandchild')` - if current state is hostPage, will go to the `hostPage.child.grandchild` state
     *
...
var StateProvider = (function () {
     ...
     *
     * ```js
     * // Auto-populates list and item views with /partials/hostPage/contact/list.html,
     * // and /partials/hostPage/contact/item.html, respectively.
     * $state.go('hostPage');
     * ```
     *
 ...
 *
 * #### Example:
 * This will activate the `hostPage` state when the link is clicked.
 * ```html
 * <a ui-sref="hostPage">Home</a>
 * ```
 *
 * ### Relative Links
 ...
 * #### Example:
 * ```html
 * <a ui-sref="hostPage" ui-sref-opts="{ reload: true }">Home</a>
 * ```
 *
 * ### Other DOM Events
 *
 ...
 *
 * ```html
 * <a href="#/hostPage" ui-sref="hostPage">Home</a>
 ...
 * </ul>
 *
 * <a href="#/hostPage" ui-sref="hostPage" ui-sref-opts="{reload: true}">Home</a>
 * ```
 *
 * ### Notes
 *
