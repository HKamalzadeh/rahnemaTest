...
export declare class StateProvider {
     ...
     * // above "hostPage" state.
     * $stateProvider.state("hostPage.newest", {});
     *
     * // Nest states as deeply as needed.
     * $stateProvider.state("hostPage.newest.abc.xyz.inception", {});
     *
     ...
     * ```
     *
     * @param {string} name A unique state name, e.g. "hostPage", "about", "contacts".
     * To create a parent/child state use a dot, e.g. "about.sales", "hostPage.newest".
